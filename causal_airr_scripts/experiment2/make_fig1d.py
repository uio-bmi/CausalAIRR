...
def main():
    ...
    for path, name in zip(
        [Path("../../results_exp2/2023-02-09_15:17:14.549052/2a/balanced_error_rate_performances.yaml"),
         Path("../../results_exp2/2023-02-09_15:17:14.549052/2b/balanced_error_rate_performances.yaml")],
