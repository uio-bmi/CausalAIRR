...
def get_repertoire(immune_state: bool, experimental_protocol_id: int, path: Path, sequence_count: int, exp_protocol_signal_name: str,
    ...
    exp_protocol_signal = make_exp_protocol_signal(protocol_id=experimental_protocol_id, signal_name=exp_protocol_signal_name)
    ...
    update_protocol_metadata(repertoire.metadata_filename, experimental_protocol_id, exp_protocol_signal_name)
...
def make_graph(data_path, p_immune_state: float, p_hospital: float, immune_state_signal: Signal, sequence_count: int, experiment_name: str,
               immune_state_implanting_rate: float, protocol_implanting_rate: float, is_train: bool, exp_protocol_signal_name: str):
    ...
    experimental_protocol_node = Node(name=exp_protocol_signal_name, function=get_exp_protocol, kwargs={"hospital": hospital_node})
...
def simulate_dataset(data_path: Path, train_example_count: int, test_example_count: int, p_immune_state: float, p_hospital: float,
                     immune_state_signal: Signal, protocol_signal_name: str, sequence_count: int,
                     immune_state_implanting_rate: float, protocol_implanting_rate: float, experiment_name: str):

    train_graph = make_graph(data_path=data_path, p_immune_state=p_immune_state, p_hospital=p_hospital, immune_state_signal=immune_state_signal,
                             ...
                             exp_protocol_signal_name=protocol_signal_name)

    signal_names = [immune_state_signal.id, protocol_signal_name]
    ...
    test_graph = make_graph(data_path=data_path, p_immune_state=p_immune_state, p_hospital=p_hospital, immune_state_signal=immune_state_signal,
                            sequence_count=sequence_count, immune_state_implanting_rate=immune_state_implanting_rate,
